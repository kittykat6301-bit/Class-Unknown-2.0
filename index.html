...
@media(max-width:700px){.border-doodles .top-left{width:230px;left:24px;top:-78px}.border-doodles .top-right{width:205px;right:22px;top:-65px}.border-doodles .side-left{left:-76px;top:180px}.border-doodles .side-right{right:-76px;top:205px}.border-doodles .bottom-left{width:205px;left:26px}.border-doodles .bottom-right{width:205px;right:24px}.border-doodles .alien-crown{width:300px;top:-104px}}
...
.card{background:linear-gradient(var(--a),var(--a)) left 7px top 7px/20px 1px no-repeat,linear-gradient(var(--a),var(--a)) left 7px top 7px/1px 20px no-repeat,linear-gradient(var(--a),var(--a)) right 7px bottom 7px/20px 1px no-repeat,linear-gradient(var(--a),var(--a)) right 7px bottom 7px/1px 20px no-repeat,linear-gradient(180deg,rgba(9,17,27,.93),rgba(5,10,16,.97))}
...
<g class="motif m-alien"><path d="M0 69 H92 C110 69 122 61 128 48 C134 35 132 24 124 17 C140 19 151 30 152 43 C153 57 143 67 128 69 H280"/><ellipse class="accent" cx="191" cy="52" rx="27" ry="8"/><path class="signal" d="M170 52 C173 38 181 31 191 31 C201 31 209 38 212 52"/><circle class="signal" cx="184" cy="44" r="1.8"/><circle class="signal" cx="198" cy="44" r="1.8"/><path class="signal" d="M191 31 V21 M191 21 C195 17 198 18 200 21"/><path class="accent" d="M229 34 C234 26 244 27 246 35 C249 27 259 26 264 34 C268 43 257 49 246 56 C235 49 225 43 229 34"/></g>
...
<g class="motif m-alien"><path d="M80 0 V60 C80 72 74 80 63 84 C51 88 40 84 35 74 C33 84 26 92 16 96 C26 100 33 108 35 118 C40 108 51 104 63 108 C74 112 80 120 80 132 V230"/><circle class="accent" cx="29" cy="54" r="1.8"/><circle class="signal" cx="18" cy="66" r="1.3"/><circle class="accent" cx="42" cy="45" r="1.1"/><path class="signal" d="M25 144 C28 153 34 159 43 162 C34 165 28 171 25 180 C22 171 16 165 7 162 C16 159 22 153 25 144"/></g>
...
<g class="motif m-alien"><path d="M14 0 V58 C14 70 20 77 31 81 C44 86 56 81 61 70 C66 81 78 86 91 81 C78 88 69 99 66 112 C63 126 69 137 80 144 C66 143 55 149 49 160 C43 171 45 183 54 192 C41 187 29 190 20 199 C16 203 14 210 14 220 V230"/><ellipse class="accent" cx="57" cy="111" rx="28" ry="11" transform="rotate(-24 57 111)"/><circle class="signal" cx="57" cy="111" r="3.2"/><circle class="accent" cx="83" cy="95" r="2"/><circle class="signal" cx="31" cy="130" r="1.5"/></g>
...
<g class="motif m-alien"><path d="M0 18 H66 C78 18 86 24 90 34 C94 45 90 55 81 60 C93 63 102 71 106 83 C110 71 119 63 131 60 C122 55 118 45 122 34 C126 24 134 18 146 18 H275"/><path class="accent" d="M165 18 C171 10 180 10 187 18 C180 26 171 26 165 18 Z"/><circle class="signal" cx="201" cy="18" r="6"/><path class="accent" d="M220 12 C226 14 229 20 227 25 C221 24 217 18 220 12 Z"/><circle class="signal" cx="242" cy="18" r="2.2"/><circle class="accent" cx="254" cy="18" r="1.4"/></g>
...
<g class="motif m-alien"><path d="M0 18 H82 C94 18 102 24 106 34 C110 45 106 54 97 59 C108 62 117 69 121 80 C125 69 134 62 145 59 C136 54 132 45 136 34 C140 24 148 18 160 18 H265"/><circle class="signal" cx="187" cy="44" r="15"/><ellipse class="accent" cx="187" cy="44" rx="27" ry="8" transform="rotate(-18 187 44)"/><path class="signal" d="M226 28 C229 37 235 43 244 46 C235 49 229 55 226 64 C223 55 217 49 208 46 C217 43 223 37 226 28"/></g>
...
<div class="record-actions"><span id="modePill" class="mode-pill">VIEW MODE</span><span id="save">Saved</span><button id="recordAction">ENTER EDIT MODE</button></div>
</div>
...
<div id="characterThemePreview" class="theme-preview">
<div><div id="charThemeGlyph" class="preview-glyph">◇</div><div id="charThemeTitle" class="preview-title">Inherited System</div><div id="charThemeSource" class="preview-sub">Uses archive personalization</div></div>
<div><div id="charThemeStyleLabel" class="preview-sub" style="margin-bottom:10px">HOLOGRAPHIC SHELL</div><div id="charThemeSwatches" class="preview-swatches"></div></div>
</div>

<div class="theme-controls">
<div class="card full">
<h3>Character System Signature</h3>
<div class="fields">
...
<div class="color-control"><label>Primary Glow</label><input id="charThemePrimary" type="color"></div>
<div class="color-control"><label>Secondary Glow</label><input id="charThemeSecondary" type="color"></div>
<div class="color-control"><label>Signal Color</label><input id="charThemeSignal" type="color"></div>
</div>
...
<p class="character-theme-note">Selecting this character anywhere in the archive automatically loads this System signature. It is stored with the character and travels with JSON exports.</p>
</div>

<div class="card full">
<h3>Portrait / Record Image</h3>
<div class="portrait-actions"><button id="portraitUpload">Upload Portrait</button><button id="portraitRemove">Remove Portrait</button><input id="portraitFile" type="file" accept="image/*" hidden></div>
<p class="character-theme-note">Images are resized before saving so the browser database stays lighter.</p>
</div>
</div>
</div>
</section>

<section id="custom" class="sheet">
<div class="custom-editor">
<div class="card full">
<h3>Custom Character Data</h3>
<p class="character-theme-note">Add fields that do not fit the standard System, Authority, or Personal templates. Fields also appear in their chosen module while viewing the record.</p>
<div id="customList" class="custom-list"></div>
<button id="addCustomField" style="margin-top:12px">＋ Add Custom Field</button>
</div>
</div>
</section>
</div>
...
if(ICON){$("#logo").src=ICON;$("#fav").href=ICON}else{$("#logo").style.display="none"}
...
else if(v&&typeof v==="object"&&base[k]&&typeof base[k]==="object"&&!Array.isArray(base[k]))base[k]=merge(base[k],v);
else base[k]=v;
}
return base;
}
...
const c=merge(blank(),raw||{});
if(!c.id)c.id=crypto.randomUUID?crypto.randomUUID():"c"+Date.now()+Math.random();
if(!Array.isArray(c.customFields))c.customFields=[];
return c;
}

let db=(()=>{
try{return JSON.parse(getStore(SK)||'{"characters":[],"activeId":null}')}
catch{return{characters:[],activeId:null}}
})();
...
const t=THEMES[key]||THEMES.system;
return{name:t[0],primary:t[1],secondary:t[2],signal:t[3],glyph:t[4],frequency:t[5],style:t[7]||"holo",source:"preset"};
}
...
name:st.name||((c.identity?.name||"Character")+" System"),
primary:st.primary||fallback.primary,
secondary:st.secondary||fallback.secondary,
signal:st.signal||fallback.signal,
glyph:st.glyph||fallback.glyph,
...
function applyTheme(){
const t=resolvedTheme(),r=document.documentElement;
r.style.setProperty("--a",t.primary);
r.style.setProperty("--b",t.secondary);
r.style.setProperty("--c",t.signal);
...
r.dataset.characterStyle=t.style||"holo";
$("#systemPersonalization").textContent=(t.source==="character"?"CHARACTER THEME: ":"PERSONALIZATION: ")+t.name.toUpperCase();
...
if(!el)return;
el.textContent=text;
el.classList.remove("saving","warn");
...
setSaveState(message||(editMode?"Draft autosaved":"Saved & locked"),ok?"":"warn");
$("#storageNote").textContent=ok?"Autosaves in this browser.":"Storage blocked. Download All before closing.";
return ok;
}
...
saveTimer=setTimeout(()=>{saveTimer=null;saveDB("Draft autosaved")},260);
}

function flushSave(message){
if(saveTimer){clearTimeout(saveTimer);saveTimer=null}
return saveDB(message);
}

function buildForms(){
for(const [sid,groups] of Object.entries(FORMS)){
const grid=$("#"+sid+" .edit-grid");
grid.innerHTML="";
...
function valueHTML(path,val){
const str=String(val||"").trim();
if(!str)return'<span class="readout-value blank-value">—</span>';

if(path==="hunter.statusEffects"){
const chips=str.split(/[,\n]/).map(x=>x.trim()).filter(Boolean).map(x=>`<span class="status-chip">${safe(x)}</span>`).join("");
return`<div class="status-chips">${chips}</div>`;
}

if(path==="personal.relationshipLinks"){
const rows=str.split(/\n/).map(x=>x.trim()).filter(Boolean).map(line=>{
const [name,...rest]=line.split(/\s*[|:]\s*/);
return`<div class="relationship-row"><b>${safe(name)}</b><span>${safe(rest.join(" · ")||"Linked")}</span></div>`;
}).join("");
return`<div class="relationship-list">${rows}</div>`;
}

return`<span class="readout-value">${safe(str)}</span>`;
}

function renderViewSection(section,c){
const grid=$("#"+section+" .view-grid");
grid.innerHTML="";

for(const [title,fields] of FORMS[section]){
const card=document.createElement("div");
card.className="card view-card"+(fields.length===1?" full":"");

if(title==="Core Stats"){
let lines=fields.map(([lab,path])=>{
const raw=read(c,path),num=parseFloat(raw),pct=Number.isFinite(num)?Math.max(0,Math.min(100,num)):0;
return`<div class="stat-line"><span class="stat-name">${safe(lab)}</span><span class="stat-track"><i class="stat-fill" style="width:${pct}%"></i></span><span class="stat-value">${safe(raw||"—")}</span></div>`;
}).join("");
card.innerHTML=`<h3>${title}</h3>${lines}`;
}else{
const inner=fields.map(([lab,path,type])=>{
const alert=path==="authority.watchStatus"&&String(read(c,path)).trim()?" watch-alert":"";
return`<div class="readout${type==="ta"?" full":""}${alert}"><span class="readout-label">${safe(lab)}</span>${valueHTML(path,read(c,path))}</div>`;
}).join("");
card.innerHTML=`<h3>${title}</h3><div class="readout-grid">${inner}</div>`;
}

grid.appendChild(card);
}

const custom=(c.customFields||[]).filter(f=>f.section===section&&String(f.label||f.value||"").trim());

if(custom.length){
const card=document.createElement("div");
card.className="card view-card full";
card.innerHTML=`<h3>Custom Data</h3><div class="readout-grid">${custom.map(f=>`<div class="readout"><span class="readout-label">${safe(f.label||"Custom Field")}</span>${valueHTML("",f.value)}</div>`).join("")}</div>`;
grid.appendChild(card);
}
}

function renderViewSections(c){
renderViewSection("system",c);
renderViewSection("authority",c);
renderViewSection("personal",c);
}

function renderHero(c){
const t=resolvedTheme(c);

$("#heroName").textContent=c.identity?.name||"Untitled Character";
$("#heroAlias").textContent=c.identity?.alias||"No codename registered";
$("#heroThemeLabel").textContent="SYSTEM SIGNATURE // "+t.name.toUpperCase();

const img=$("#portraitImg"),glyph=$("#portraitGlyph");

if(c.media?.portrait){
img.src=c.media.portrait;
img.hidden=false;
glyph.hidden=true;
}else{
img.hidden=true;
...
const chips=[];
if(c.hunter?.rank)chips.push(["RANK // "+c.hunter.rank,""]);
if(c.hunter?.class)chips.push(["CLASS // "+c.hunter.class,""]);
if(c.hunter?.level)chips.push(["LEVEL // "+c.hunter.level,""]);
if(c.authority?.watchStatus)chips.push(["WATCH // "+c.authority.watchStatus,"alert"]);

$("#heroChips").innerHTML=chips.map(([x,cl])=>`<span class="hero-chip ${cl}">${safe(x)}</span>`).join("");

const statuses=String(c.hunter?.statusEffects||"").split(/[,\n]/).map(x=>x.trim()).filter(Boolean);
$("#heroStatus").innerHTML=statuses.map(x=>`<span class="status-chip">${safe(x)}</span>`).join("");
}

function renderList(){
const q=$("#search").value.toLowerCase(),g=$("#charList");
g.innerHTML="";

const chars=db.characters.filter(c=>((c.identity?.name||"")+" "+(c.identity?.alias||"")).toLowerCase().includes(q));

for(const c of chars){
const t=resolvedTheme(c),b=document.createElement("button");
b.className="char"+(c.id===active&&!homeMode?" active":"");
const meta=[c.hunter?.rank&&c.hunter.rank+" Rank",c.hunter?.class].filter(Boolean).join(" · ");
b.innerHTML=`<b>${safe(c.identity?.name||"Untitled Character")}</b><small>${safe(meta||t.name)}</small>`;
b.onclick=()=>openCharacter(c.id);
g.appendChild(b);
}

if(!g.children.length)g.innerHTML='<small class="muted">No characters yet.</small>';
}
...
g.innerHTML='<div class="custom-empty" style="grid-column:1/-1">No records yet. Create your first character to begin the archive.</div>';
return;
}

for(const c of db.characters){
const t=resolvedTheme(c),card=document.createElement("button");
card.className="archive-card";
card.style.setProperty("--card1",t.primary);
card.style.setProperty("--card2",t.secondary);

const meta=[c.hunter?.rank&&"Rank "+c.hunter.rank,c.hunter?.class].filter(Boolean);

card.innerHTML=`
<span class="theme-signature">
<i style="background:${t.primary};color:${t.primary}"></i>
<i style="background:${t.secondary};color:${t.secondary}"></i>
<i style="background:${t.signal};color:${t.signal}"></i>
</span>
<span class="archive-glyph">${safe(t.glyph||"◇")}</span>
<span class="archive-name">${safe(c.identity?.name||"Untitled Character")}</span>
<span class="archive-alias">${safe(c.identity?.alias||t.name)}</span>
<span class="archive-meta">${meta.map(x=>`<span class="mini-badge">${safe(x)}</span>`).join("")}</span>`;
...
function showHome(){
flushSave(editMode?"Draft saved":"Saved & locked");
editMode=false;
homeMode=true;
...
if(!editMode){
e.style.height="auto";
e.style.height=Math.max(42,e.scrollHeight)+"px";
}
});
}
...
editor.classList.toggle("edit-mode",editMode);
editor.classList.toggle("view-mode",!editMode);

$$("[data-path]").forEach(e=>{
e.readOnly=!editMode;
e.tabIndex=editMode?0:-1;
e.placeholder=editMode?"":"—";
e.setAttribute("aria-readonly",editMode?"false":"true");
});

$$("#characterTheme input,#characterTheme select,#characterTheme button,#custom input,#custom textarea,#custom select,#custom button").forEach(e=>{
if(e.id==="portraitFile")return;
e.disabled=!editMode;
});

$("#recordAction").textContent=editMode?"SAVE & LOCK":"ENTER EDIT MODE";
$("#modePill").textContent=editMode?"EDIT MODE":"VIEW MODE";

if($("#archiveStateLabel"))$("#archiveStateLabel").textContent=editMode?"EDITING":"LOCKED";

if(!editMode)requestAnimationFrame(sizeReadouts);
}
...
function populateCharThemePresets(){
const s=$("#charThemePreset");
s.innerHTML="";
...
const st=c.systemTheme||blank().systemTheme;

$("#charThemeMode").value=st.mode||"inherit";
$("#charThemePreset").value=st.preset||"alien";
$("#charThemeName").value=st.name||"";
$("#charThemeGlyphInput").value=st.glyph||"✦";
$("#charThemeStyle").value=st.style||"holo";
$("#charThemeNote").value=st.note||"";
$("#charThemePrimary").value=st.primary||"#86f3ef";
$("#charThemeSecondary").value=st.secondary||"#ffabc9";
$("#charThemeSignal").value=st.signal||"#aef7d7";

const custom=st.mode==="custom";

["#charThemeName","#charThemeGlyphInput","#charThemeStyle","#charThemeNote","#charThemePrimary","#charThemeSecondary","#charThemeSignal"].forEach(id=>{
$(id).disabled=!editMode||!custom;
});

$("#charThemePreset").disabled=!editMode||st.mode!=="preset";

const t=resolvedTheme(c);

$("#charThemeGlyph").textContent=t.glyph||"◇";
$("#charThemeTitle").textContent=t.name;
$("#charThemeSource").textContent=st.mode==="inherit"?"INHERITS ARCHIVE PERSONALIZATION":st.mode==="preset"?"CHARACTER PRESET":"CUSTOM CHARACTER SYSTEM";
$("#charThemeStyleLabel").textContent=(t.style||"holo").toUpperCase()+" SHELL";
$("#charThemeSwatches").innerHTML=`<i style="background:${t.primary};color:${t.primary}"></i><i style="background:${t.secondary};color:${t.secondary}"></i><i style="background:${t.signal};color:${t.signal}"></i>`;
}

function updateCharTheme(){
const c=current();
if(!c||!editMode)return;

c.systemTheme={
...c.systemTheme,
mode:$("#charThemeMode").value,
preset:$("#charThemePreset").value,
name:$("#charThemeName").value,
primary:$("#charThemePrimary").value,
secondary:$("#charThemeSecondary").value,
signal:$("#charThemeSignal").value,
glyph:$("#charThemeGlyphInput").value||"✦",
style:$("#charThemeStyle").value,
note:$("#charThemeNote").value
};
...
function copyGlobalIntoCharacter(){
const c=current();
if(!c||!editMode)return;

const t=presetTheme(settings.theme);

c.systemTheme={
...c.systemTheme,
mode:"custom",
preset:settings.theme,
name:(c.identity?.name||"Character")+" System",
primary:t.primary,
...
renderHero(c);
renderHome();
toast("CHARACTER THEME RESET");
}

function renderCustomEditor(){
const c=current(),g=$("#customList");
if(!c||!g)return;

g.innerHTML="";

if(!c.customFields.length){
g.innerHTML='<div class="custom-empty">No custom fields yet.</div>';
return;
}
...
row.innerHTML=`
<select data-custom-section="${i}">
<option value="system">System / Hunter</option>
<option value="authority">Authority</option>
<option value="personal">Personal</option>
</select>
<input data-custom-label="${i}" placeholder="Field label" value="${safe(f.label||"")}">
<textarea data-custom-value="${i}" placeholder="Value">${safe(f.value||"")}</textarea>
<button data-custom-remove="${i}" class="danger">Remove</button>`;
g.appendChild(row);
$(`[data-custom-section="${i}"]`,row).value=f.section||"system";
});

$$("[data-custom-section], [data-custom-label], [data-custom-value]",g).forEach(el=>{
el.disabled=!editMode;

el.oninput=()=>{
if(!editMode)return;

const i=+(el.dataset.customSection??el.dataset.customLabel??el.dataset.customValue);
const f=c.customFields[i];

if(el.dataset.customSection!==undefined)f.section=el.value;
if(el.dataset.customLabel!==undefined)f.label=el.value;
if(el.dataset.customValue!==undefined)f.value=el.value;
...
$$("[data-custom-remove]",g).forEach(b=>{
b.disabled=!editMode;

b.onclick=()=>{
if(!editMode)return;
c.customFields.splice(+b.dataset.customRemove,1);
scheduleSave();
renderCustomEditor();
renderViewSections(c);
};
...
o.type=t.style==="glitch"?"square":t.style==="abyssal"?"sawtooth":"triangle";
o.frequency.value=kind==="page"?t.frequency*1.45:t.frequency;
...
write(c,e.dataset.path,e.value);
c.updatedAt=new Date().toISOString();

if(e.dataset.path==="identity.name"){
$("#title").textContent=e.value||"Untitled Character";
}
...
$$(".sheet").forEach(x=>x.classList.remove("active"));

b.classList.add("active");
$("#"+b.dataset.tab).classList.add("active");
$("#editor").dataset.module=b.dataset.tab;

renderThemeEditor();
renderCustomEditor();

b.scrollIntoView({
behavior:settings.reduce?"auto":"smooth",
block:"nearest",
inline:"nearest"
});
...
$('[data-path="identity.name"]').focus();
}

$("#new").onclick=makeNew;
$("#homeNew").onclick=makeNew;
...
const n=normalizeCharacter(JSON.parse(JSON.stringify(c)));

n.id=crypto.randomUUID?crypto.randomUUID():"c"+Date.now();
n.identity.name=(n.identity.name||"Untitled Character")+" Copy";
...
if(c&&confirm(`Delete "${c.identity?.name||"Untitled Character"}"?`)){
flushSave(editMode?"Draft saved":"Saved & locked");

db.characters=db.characters.filter(x=>x.id!==c.id);
active=db.characters[0]?.id||null;
editMode=false;
homeMode=true;
...
const c=current();
if(c){
download(c,(c.identity?.name||"character").replace(/[^\w-]+/g,"_")+".json");
}
};

$("#expAll").onclick=()=>{
download({schemaVersion:4,characters:db.characters},"class-unknown-character-database.json");
};
...
const arr=Array.isArray(p)?p:Array.isArray(p.characters)?p.characters:[p];
const ids=new Set(db.characters.map(x=>x.id));
const imported=[];

for(const raw of arr){
const x=normalizeCharacter(raw);

if(ids.has(x.id)){
x.id=crypto.randomUUID?crypto.randomUUID():"c"+Date.now()+Math.random();
}
...
active=imported[0]?.id||active;
homeMode=!active;
editMode=false;

saveDB("Imported & locked");
render();

toast(`${imported.length} RECORD${imported.length===1?"":"S"} IMPORTED`);
}catch(err){
...
if(editMode){
editMode=false;
flushSave("Saved & locked");
applyRecordMode();
renderThemeEditor();
renderCustomEditor();
toast("ARCHIVE RECORD LOCKED");
tone("page");
}else{
editMode=true;
setSaveState("Editing draft");
applyRecordMode();
renderThemeEditor();
renderCustomEditor();
tone("page");
...
$(id).oninput=updateCharTheme;
$(id).onchange=updateCharTheme;
});

$("#copyGlobalTheme").onclick=copyGlobalIntoCharacter;
$("#resetCharTheme").onclick=resetCharacterTheme;

$("#portraitUpload").onclick=()=>{
if(editMode)$("#portraitFile").click();
};

$("#portraitRemove").onclick=()=>{
const c=current();
if(!c||!editMode)return;
...
$("#portraitFile").onchange=async e=>{
const c=current();
const file=e.target.files[0];

if(c&&file&&editMode){
try{
c.media.portrait=await compressPortrait(file);
scheduleSave();
renderHero(c);
...
if(!b.closest(".tabs")&&!b.classList.contains("theme")){
tone(b.id==="del"?"danger":"click");
}
});
